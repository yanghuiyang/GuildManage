...
<html>
  ...
  <body>
      <s:form action="roleright/sys/users!edit.action" method="post">
    	<table style="width:100%">
    		...
    		<tr>
    			...
    			<td>
    				<select name="user.role.roleId" value="user.role.roleId">
    		...
    		<tr>
    			...
    			<td>
    				<input type="text" name="user.userTrueName" value="${user.userTrueName}"/>
    			</td>
    		</tr>
    		<tr>
    			<td style="width:30%;text-align: right">用户是否可用：</td>
    			<td>
    				<select name="user.userIsused" value="user.userIsused">
